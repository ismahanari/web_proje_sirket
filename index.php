				...
				<div class="col-md-8">
					<div class="navmenu"style="text-align: center;">
						<ul id="menu">
							...
							<li class="last"><a href="anasayfa.php?sayfa=iletisim">İletişim</a></li>
						...
						<div class="camera_wrap camera_white_skin" id="camera_wrap_1">
							<div data-thumb="" data-src="images/slides/blank.gif">
								<div class="img-responsive camera_caption fadeFromBottom">
									<h2><?php echo $genel_bilgiler['slagon_1'] ?></h2>
								</div>
							</div>
							<div data-thumb="" data-src="images/slides/blank.gif">
								<div class="img-responsive camera_caption fadeFromBottom">
									<h2><?php echo $genel_bilgiler['slagon_2'] ?></h2>
								</div>
							</div>
							<div data-thumb="" data-src="images/slides/blank.gif">
								<div class="img-responsive camera_caption fadeFromBottom">
									<h2><?php echo $genel_bilgiler['slagoni_3'] ?></h2>
								</div>
							</div>
						</div><!-- #camera_wrap_1 -->
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 project">
					<h3 id="counter">0</h3>
					<h4><?php echo $genel_bilgiler['aciklama_1_adi'] ?></h4>
					<p><?php echo $genel_bilgiler['acıklama_1'] ?></p>
				</div>
				<div class="col-md-4 project">
					<h3 id="counter1">0</h3>
					<h4><?php echo $genel_bilgiler['aciklama_2_adi'] ?></h4>
					<p><?php echo $genel_bilgiler['acıklama_2'] ?></p>
				</div>
				<div class="col-md-4 project">
					<h3 id="counter2" style="margin-left: 20px;">0</h3>
					<h4 style="margin-left: 20px;"><?php echo $genel_bilgiler['aciklama_3_adi'] ?></h4>
					<p><?php echo $genel_bilgiler['acıklama_3'] ?> </p>
				</div>
			</div>
		</div>
		<div class="container">
			<div class="row">
				<div class="col-md-12 cBusiness">
					<h3><?php echo $genel_bilgiler['genel_acıklama'] ?></h3>
				</div>
			</div>
		</div>
		<div class="container">
